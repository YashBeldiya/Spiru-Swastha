...
const EmailVerify = () => {
  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-[#e9f2fb]'>
        <div
    className="max-w-[500px] rounded-[40px] border-4 border-white bg-gradient-to-b
  ...
  >
    ...
    <form className="mt-6 space-y-4" action="#">
      <input
        ...
        placeholder="E-mail"
        required
        className="w-full rounded-[20px] border-2 border-transparent bg-white
               px-5 py-3 text-sm placeholder:text-gray-400
               shadow-[0_10px_10px_-5px_#cff0ff] focus:border-[#12b1d1] focus:outline-none"
      />

      <button
        type="button" onClick={otpverification}
